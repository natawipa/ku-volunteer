    ...
    return (
      <div className="relative">
        ...
        <Link href="admin/student-list">
          <h3 className="font-semibold mb-4 text-xl bg-gradient-to-r from-blue-300/25 to-purple-300/25 p-5 w-full rounded-lg shadow-md hover:scale-102 transition-transform duration-200">Student List</h3>
        </Link>
        <Link href="admin/organization-list">
          <h3 className="font-semibold mb-4 text-xl bg-gradient-to-r from-blue-300/25 to-purple-300/25 p-5 w-full rounded-lg shadow-md hover:scale-102 transition-transform duration-200">Organization List</h3>
        </Link>
