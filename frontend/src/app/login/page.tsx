...
const LoginPage: React.FC = () => {
  ...
  return (
    <div className="min-h-screen  bg-gradient-to-br from-mutegreen to-white flex items-center justify-center p-4 relative overflow-hidden">
      ...
      {/* card */}
      <div className="bg-white rounded-2xl shadow-xl p-4 w-full max-w-md relative z-10">
        {/* Logo */}
        ...
        <h1 className="text-2xl font-semibold text-gray-900 text-center mb-8">Log in</h1>
