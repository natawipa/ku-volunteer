...
- PostgreSQL database
- **PgBouncer** (connection pooling): http://localhost:6432
...
The application uses **PgBouncer** for database connection pooling and includes **Prometheus + Grafana** for system monitoring (accessible at http://localhost:9090 and http://localhost:3001 respectively).
