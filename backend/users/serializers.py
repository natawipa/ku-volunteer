...
class StudentProfileSerializer(serializers.ModelSerializer):
    class Meta:
        ...
        fields = ["student_id_external", "graduation_year"]
...
class UserSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = User
        fields = ["id", "email", "first_name", "last_name", "role", "created_at", "updated_at", "profile"]
...
class UserRegisterSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = User
        fields = ["email", "password", "first_name", "last_name", "role", "student_id_external"]
    ...
    def create(self, validated_data):
        ...
        if validated_data.get("role") == "student" and student_id_external:
            StudentProfile.objects.create(user=user, student_id_external=student_id_external)
        return user
